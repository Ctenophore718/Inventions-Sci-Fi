...
export const generateBlazingLeapJSX = (cooldown: number, rangeBonus: number, damageBonus: number, repeatCount: number) => {
  ...
  return (
    <span style={{ color: '#000', fontWeight: 400 }}>
      <b><i style={{ color: '#b31111' }}>Blazing Leap</i></b> <span style={{ color: '#b31111', fontSize: '1em' }}><i>(Cooldown <b style={{ color: '#000', fontStyle: 'normal' }}>[{cooldown}]</b>).</i></span> Enemies within <b>[{rangeBonus}]</b>hx of you take <b>[{damageBonus}]</b>d6 <b><u style={{ color: '#d63300', display: 'inline-flex', alignItems: 'center' }}>Fire<img src="/Fire.png" alt="Fire" style={{ width: 16, height: 16, marginLeft: 2, verticalAlign: 'middle' }} /></u></b>. You then <i>Teleport</i> up to <b>[4]</b>hx.{repeatText}
    </span>
  );
};
...
export const generateBlazingLeapCardJSX = (cooldown: number, rangeBonus: number, damageBonus: number, repeatCount: number) => {
  ...
  return (
    <span style={{ color: '#000', fontWeight: 400 }}>
      Enemies within <b>[{rangeBonus}]</b>hx of you take <b>[{damageBonus}]</b>d6 <b><u style={{ color: '#d63300', display: 'inline-flex', alignItems: 'center' }}>Fire<img src="/Fire.png" alt="Fire" style={{ width: 16, height: 16, marginLeft: 2, verticalAlign: 'middle' }} /></u></b>. You then <i>Teleport</i> up to <b>[4]</b>hx.{repeatText}
    </span>
  );
};
